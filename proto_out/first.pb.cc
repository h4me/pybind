...
extern PROTOBUF_INTERNAL_EXPORT_first_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_first_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_first_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_first_2eproto;
namespace tutorial {
...
static void InitDefaultsPerson_PhoneNumber_first_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_first_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsPerson_PhoneNumber_first_2eproto}, {}};

static void InitDefaultsPerson_first_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_first_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsPerson_first_2eproto}, {
      &scc_info_Person_PhoneNumber_first_2eproto.base,}};

static void InitDefaultsAddressBook_first_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AddressBook_first_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsAddressBook_first_2eproto}, {
      &scc_info_Person_first_2eproto.base,}};

void InitDefaults_first_2eproto() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_PhoneNumber_first_2eproto.base);
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_first_2eproto.base);
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AddressBook_first_2eproto.base);
}

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_first_2eproto[3];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_first_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_first_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_first_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
static ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptorsTable assign_descriptors_table_first_2eproto = {
  {}, AddDescriptors_first_2eproto, "first.proto", schemas,
  file_default_instances, TableStruct_first_2eproto::offsets,
  file_level_metadata_first_2eproto, 3, file_level_enum_descriptors_first_2eproto, file_level_service_descriptors_first_2eproto,
};

const char descriptor_table_protodef_first_2eproto[] =
  "\n\013first.proto\022\010tutorial\"\333\001\n\006Person\022\014\n\004na"
  ...
  "utorial.Person"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_first_2eproto = {
  false, InitDefaults_first_2eproto, 
  descriptor_table_protodef_first_2eproto,
  "first.proto", &assign_descriptors_table_first_2eproto, 294,
};

void AddDescriptors_first_2eproto() {
  static constexpr ::PROTOBUF_NAMESPACE_ID::internal::InitFunc deps[1] =
  {
  };
 ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_first_2eproto, deps, 0);
}

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_first_2eproto = []() { AddDescriptors_first_2eproto(); return true; }();
namespace tutorial {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Person_PhoneType_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&assign_descriptors_table_first_2eproto);
  return file_level_enum_descriptors_first_2eproto[0];
}
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1: {
        ...
        ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(mutable_number(), ptr, ctx, "tutorial.Person.PhoneNumber.number");
        GOOGLE_PROTOBUF_PARSER_ASSERT(ptr);
        break;
      }
...
::PROTOBUF_NAMESPACE_ID::Metadata Person_PhoneNumber::GetMetadata() const {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::assign_descriptors_table_first_2eproto);
  return ::file_level_metadata_first_2eproto[kIndexInFileMessages];
}
...
void AddressBook::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(
      &scc_info_AddressBook_first_2eproto.base);
}
